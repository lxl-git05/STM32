...
// 用来一般化初始化PID结构体
void My_PID_Init(My_Pid_Typedef *pid, float kp, float ki, float kd , float OutMax , float OutMin , float ioutMax ) ;

// PID值更新,更新值直接写入PID的Output
void My_PID_Update(My_Pid_Typedef *pid, float ActualValue) ;
