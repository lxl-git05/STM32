...
{
	if (n == KEY_1 && HAL_GPIO_ReadPin(KEY1_GPIO_Port, KEY1_Pin) == GPIO_PIN_RESET)
	{
		return KEY_PRESSED;
	}
	else if (n == KEY_2 && HAL_GPIO_ReadPin(KEY2_GPIO_Port, KEY2_Pin) == GPIO_PIN_RESET)
	{
		return KEY_PRESSED;
	}
	else if (n == KEY_3 && HAL_GPIO_ReadPin(KEY3_GPIO_Port, KEY3_Pin) == GPIO_PIN_RESET)
	{
		return KEY_PRESSED;
	}
	else if (n == KEY_4 && HAL_GPIO_ReadPin(KEY4_GPIO_Port, KEY4_Pin) == GPIO_PIN_RESET)
	{
		return KEY_PRESSED;
	}
