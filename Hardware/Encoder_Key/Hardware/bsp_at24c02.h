...
/*
	声明：这是基于STM32F103C8T6建立的工程,后续业务修改只需要修改底层驱动即可
	1. 软件GPIO重定义
	2. 硬件IIC重定义
	3. 微秒延时重定义
*/
...
/* ---- 软件I2C GPIO定义（PB14=AT_SCL, PB15=AT_SDA，已在.ioc声明label）---- */
#define AT24C02_SCL_PORT      GPIOB
#define AT24C02_SCL_PIN       AT_SCL_Pin       // PB14
#define AT24C02_SDA_PORT      GPIOB
#define AT24C02_SDA_PIN       AT_SDA_Pin       // PB15
...
/* 微秒延时（72MHz空循环，约1us/8次） */
#define AT24C02_DELAY_US(n)    do { volatile uint32_t _d = (n) * 8; while(_d--) __NOP(); } while(0)
#endif
