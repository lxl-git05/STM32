...
/* ==================== 业务全局变量定义示例 ==================== */
extern int32_t  g_motorSpeed ;  // 电机速度
extern float    g_pidKp      ;  // PID比例系数
extern float    g_pidKi      ;  // PID积分系数
extern float    g_pidKd      ;  // PID微分系数
extern int8_t   g_mode       ;  // 模式  
